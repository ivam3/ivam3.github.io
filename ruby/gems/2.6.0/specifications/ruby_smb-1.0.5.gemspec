...
Gem::Specification.new do |s|
  ...
  s.authors = ["David Maloney".freeze, "James Lee".freeze, "Dev Mohanty".freeze, "Christophe De La Fuente".freeze]
  ...
  s.email = ["DMaloney@rapid7.com".freeze, "egypt@metasploit.com".freeze, "dev_mohanty@rapid7.com".freeze, "paristvinternet-github@yahoo.com".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<windows_error>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<windows_error>.freeze, [">= 0"])
