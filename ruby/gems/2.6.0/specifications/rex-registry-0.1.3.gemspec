# -*- encoding: utf-8 -*-
# stub: rex-registry 0.1.3 ruby lib

Gem::Specification.new do |s|
  s.name = "rex-registry".freeze
  s.version = "0.1.3"
  ...
  s.date = "2017-05-11"
  s.description = "Ruby Exploitation(Rex) library for parsing offline registry files from a Windows machine".freeze
  s.email = ["DMaloney@rapid7.com".freeze]
  s.homepage = "https://github.com/rapid7/rex-registry".freeze
  s.required_ruby_version = Gem::Requirement.new(">= 2.2.0".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "Rex Library for parsing offline registry hives".freeze
