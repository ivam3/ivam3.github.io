# -*- encoding: utf-8 -*-
# stub: rex-ole 0.1.6 ruby lib

Gem::Specification.new do |s|
  s.name = "rex-ole".freeze
  s.version = "0.1.6"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Pearce Barry".freeze]
  s.bindir = "exe".freeze
  ...
  s.date = "2017-05-11"
  s.description = "Ruby Exploitation(Rex) library gem for reading/writing Object-Linking-and-Embedding (OLE) files and streams".freeze
  s.email = ["pearce_barry@rapid7.com".freeze]
  s.homepage = "https://github.com/rapid7/rex-ole".freeze
  s.required_ruby_version = Gem::Requirement.new(">= 2.2.0".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "Rex Library for working with OLE".freeze
