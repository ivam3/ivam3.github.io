# -*- encoding: utf-8 -*-
# stub: rex-nop 0.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "rex-nop".freeze
  s.version = "0.1.1"
  ...
  s.date = "2017-05-11"
  s.description = "This library contains the opty2 library for dynamic generation of x86 multi-byte NOPs.\n                          This is useful in writing exploits and encoders. It allows you to dynamic generate variable\n                          length instruction sets that are equivalent to a No Operation(NOP) without using\n                          the actual 0x90 bytecode. The original code was written by Optyx and spoonm. ".freeze
  s.email = ["DMaloney@rapid7.com".freeze]
  s.homepage = "https://github.com/rapid7/rex-nop".freeze
  s.required_ruby_version = Gem::Requirement.new(">= 2.2.0".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "Ruby Exploitation(REX) library for NOP generation.".freeze
