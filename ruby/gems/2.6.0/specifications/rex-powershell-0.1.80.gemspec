# -*- encoding: utf-8 -*-
# stub: rex-powershell 0.1.80 ruby lib

Gem::Specification.new do |s|
  s.name = "rex-powershell".freeze
  s.version = "0.1.80"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["David 'thelightcosine' Maloney".freeze]
  s.bindir = "exe".freeze
  ...
  s.date = "2019-04-06"
  s.description = "Ruby Exploitation(Rex) library for generating/manipulating Powershell scripts".freeze
  s.email = ["DMaloney@rapid7.com".freeze]
  s.homepage = "https://github.com/rapid7/rex-powershell".freeze
  s.required_ruby_version = Gem::Requirement.new(">= 2.2.0".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "Rex Powershell Utilities".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rex-random_identifier>.freeze, [">= 0"])
    else
      s.add_dependency(%q<bundler>.freeze, ["~> 1.12"])
      s.add_dependency(%q<rake>.freeze, ["~> 10.0"])
      s.add_dependency(%q<rspec>.freeze, ["~> 3.0"])
      s.add_dependency(%q<rex-text>.freeze, [">= 0"])
      s.add_dependency(%q<rex-random_identifier>.freeze, [">= 0"])
    end
  else
    s.add_dependency(%q<bundler>.freeze, ["~> 1.12"])
    s.add_dependency(%q<rake>.freeze, ["~> 10.0"])
