# -*- encoding: utf-8 -*-
# stub: rex-struct2 0.1.2 ruby lib

Gem::Specification.new do |s|
  s.name = "rex-struct2".freeze
  s.version = "0.1.2"
  ...
  s.date = "2017-05-11"
  s.description = "Ruby Exploitation(Rex) library for generating/manipulating C-Style structs".freeze
  s.email = ["DMaloney@rapid7.com".freeze]
  s.homepage = "https://github.com/rapid7/rex-struct2".freeze
  s.required_ruby_version = Gem::Requirement.new(">= 2.2.0".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "Rex C-Struct Library".freeze
