# -*- encoding: utf-8 -*-
# stub: rex-rop_builder 0.1.3 ruby lib

Gem::Specification.new do |s|
  s.name = "rex-rop_builder".freeze
  s.version = "0.1.3"
  ...
  s.executables = ["msfrop".freeze]
  s.files = ["bin/msfrop".freeze]
  s.homepage = "https://github.com/rapid7/rex-rop_builder".freeze
  s.required_ruby_version = Gem::Requirement.new(">= 2.2.0".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "Ruby Exploitation(Rex) Library for building ROP chains.".freeze
