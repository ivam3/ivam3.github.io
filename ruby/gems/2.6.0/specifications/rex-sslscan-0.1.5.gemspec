# -*- encoding: utf-8 -*-
# stub: rex-sslscan 0.1.5 ruby lib

Gem::Specification.new do |s|
  s.name = "rex-sslscan".freeze
  s.version = "0.1.5"
  ...
  s.date = "2017-08-16"
  s.description = "This library is a pure ruby implmenetation of the SSLScan tool originally written\n                          by Ian Ventura-Whiting. It currently depends on the system version of OpenSSL".freeze
  s.email = ["DMaloney@rapid7.com".freeze]
  s.homepage = "https://github.com/rapid7/rex-sslscan".freeze
  s.required_ruby_version = Gem::Requirement.new(">= 2.2.0".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "Ruby Exploitation(REX) Library for scanning the SSL/TLS capabilities of a server".freeze
