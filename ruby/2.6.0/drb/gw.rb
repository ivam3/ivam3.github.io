...
s1 = DRb::DRbServer.new('drbunix:/data/data/com.termux/files/usr/tmp/gw_b_a', front)
s2 = DRb::DRbServer.new('drbunix:/data/data/com.termux/files/usr/tmp/gw_b_c', front)
...
obj = Foo.new('a')
DRb.start_service("drbunix:/data/data/com.termux/files/usr/tmp/gw_a", obj)

robj = DRbObject.new_with_uri('drbunix:/data/data/com.termux/files/usr/tmp/gw_b_a')
robj[:a] = obj
...
DRb.start_service("drbunix:/data/data/com.termux/files/usr/tmp/gw_c", nil)

robj = DRbObject.new_with_uri("drbunix:/data/data/com.termux/files/usr/tmp/gw_b_c")
