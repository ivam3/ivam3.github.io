...
class Dir
  ...
  @@systmpdir ||= defined?(Etc.systmpdir) ? Etc.systmpdir : '/data/data/com.termux/files/usr/tmp'
  ...
  def self.tmpdir
    if $SAFE > 0
      ...
      tmp = nil
      [ENV['TMPDIR'], ENV['TMP'], ENV['TEMP'], @@systmpdir, '/data/data/com.termux/files/usr/tmp', '.'].each do |dir|
        next if !dir
